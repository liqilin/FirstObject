...
//连接打印机
-(RET_PTK)PTKConnect:(NSString*)strIPAddress andPort:(int)nPort;
...
-(RET_PTK)PTK_DrawBar2D_DATAMATRIX:(int)x andY:(int)y andW:(int)w andV:(int)v andO:(int)o andM:(int)m  andStr:strStr;
-(RET_PTK)PTK_DrawBar2D_QR:(int)x andY:(int)y andW:(int)w andV:(int)v andO:(int)o andR:(int)r andM:(int)m andG:(int)g andS:(int)s andStr:strStr;
